...
If it was 1 if would give use means along the rows. 2 goes along the columns.
...
To compute the proportion of variance explained (PVE) by each principal component, we simply divide the variance explained by each principal component by the total variance explained by all four principal components:
